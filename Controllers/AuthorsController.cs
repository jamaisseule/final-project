...
namespace LUMOSBook.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        public AuthorsController(LUMOSBookIdentityDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Author != null ? 
                          ...
                          Problem("Entity set 'LUMOSBookContext.Author'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LUMOSBookContext.Author'  is null.");
            }
            var author = await _context.Author.FindAsync(id);
            if (author != null)
            {
